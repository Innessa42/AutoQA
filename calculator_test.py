...
#cal = Calculator()
#
## testiruiem metod sum
#
#res = cal.sum(4, 5)
#assert res == 9, "rezulitat ne sovpal"
#
#res1 = cal.sum(-4, 2)
#assert res1 == 2, "rezulitat ne sovpal"
#
#res2 = cal.avg([1,2, 3])
#assert res2 == 2, "rezulitat ne sovpal"
#
#
####################  varianta invatator####
#from calculator import Calculator
...
#        (2.5, 3.5, 6.0),
#    ])
#    def test_sum_po_muns(a, b, exp):
#        assert cal.sum(a, b) == exp
